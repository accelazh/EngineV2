...
public class TestingSimplePasswordManager extends TestCase
{
	private SimplePasswordManager passwordManager = new SimplePasswordManager();
	...
	{
		super.setUp();
		passwordManager = new SimplePasswordManager();
	}
