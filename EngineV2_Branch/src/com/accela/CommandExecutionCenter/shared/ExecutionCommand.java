 ...
 * 1、发布命令者的ID，即ExecutionCommanderID
...
public class ExecutionCommand
{
	 ...
	 * 发布命令者的ID
	 */
	private ExecutionCommanderID commanderID;
	/**
	 * 具体的命令
	 */
	...
	public ExecutionCommand(ExecutionCommanderID commanderID, String commandHead)
	{
		this(commanderID, commandHead, null);
	}
	
	public ExecutionCommand(ExecutionCommanderID commanderID, String commandHead, Object argument)
	{
		if(null==commanderID)
		{
	...
	public ExecutionCommanderID getCommanderID()
	{
		return commanderID;
	}
